...
const STEPS = [
  ...
  },
  {
    ...
    body: "Teammates join with an email invite. Spend appears in the shared dashboard — and in the VS Code extension, right in the editor.",
    terminal: (
      <>
        <div>
        ...
        <div className="t-green">✓ live — console.planckspace.dev</div>
      </>
    ),
  },
];
...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="scroll-mt-24 py-24 sm:py-36">
